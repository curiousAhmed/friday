...
from friday_widgets.forms import default_select_option_template
...
class DahuaUserForm(Form):
    """
    This form is used to map a Friday employee to a user entry on a Dahua biometric device.
    """
...
class MapBioUsers(ModelForm):
    """
    Form for mapping biometric users to Friday employees.

    This form is used to associate a biometric user (from a biometric device) with
    an employee in the Friday system.
    """
