...
class AssetCategory(FridayModel):
    """
...
class Asset(FridayModel):
    ...
    objects = FridayCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(FridayModel):
    """
...
class ReturnImages(FridayModel):
    """
...
class AssetAssignment(FridayModel):
    """
    ...
    objects = FridayCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(FridayModel):
    """
