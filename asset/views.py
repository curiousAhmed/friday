...
from friday.friday_settings import HORILLA_DATE_FORMATS
from friday.methods import friday_users_with_perms
...
def asset_allocate_return_request(request, asset_id):
    ...
    permed_users = friday_users_with_perms("asset.change_assetassignment")
    notify.send(
        request.user.employee_get,
