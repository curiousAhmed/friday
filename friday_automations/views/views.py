...
from friday_automations.signals import REFRESH_METHODS
...
@login_required
@permission_required("friday_automation.delete_mailautomation")
...
@login_required
@permission_required("friday_automation.add_mailautomation")
