...
class AutomationNavView(views.FridayNavView):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("friday_automation.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("friday_automation.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "friday_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = FridayMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = FridayMailTemplate.objects.filter(
                body=template_body
            ).first()
