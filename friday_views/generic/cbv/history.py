"""
friday_views/generic/cbv/history.py
"""
...
from friday_views.cbv_methods import hx_request_required
from friday_views.generic.cbv.views import FridayFormView
from friday_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class FridayHistoryView(DetailView):
    """
    GenericFridayProfileView
    """

    template_name = "generic/friday_history_view.html"
