...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=friday,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="friday"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=friday,dc=com"),
}
