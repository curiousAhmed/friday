...
class SurveyTemplate(FridayModel):
    """
...
class Stage(FridayModel):
    ...
    objects = FridayCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(FridayModel):
    """
    RejectReason
    """
...
class RejectedCandidate(FridayModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(FridayModel):
    """
    ...
    objects = FridayCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(FridayModel):
    """
...
class RecruitmentSurveyAnswer(FridayModel):
    """
...
class SkillZoneCandidate(FridayModel):
    """
...
class CandidateRating(FridayModel):
...
class RecruitmentGeneralSetting(FridayModel):
    """
...
class InterviewSchedule(FridayModel):
    """
    ...
    objects = FridayCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(FridayModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(FridayModel):
...
class LinkedInAccount(FridayModel):
