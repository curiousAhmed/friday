...
class LinkedinSettingSectionView(views.FridaySectionView):
    """
...
class LinkedInSettingNavView(views.FridayNavView):
    """
...
class LinkedInAccountFormView(views.FridayFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.FridayListView):
    """
