...
from friday.group_by import group_by_queryset as group_by
...
def get_notice_period(request):
    ...
    employee_id = request.GET["employee_id"]
    if apps.is_installed("payroll"):
        Contract = get_friday_model_class(app_label="payroll", model="contract")
        employee_contract = (
            (
...
def offboarding_dashboard(request):
    ...
    if apps.is_installed("recruitment"):
        Candidate = get_friday_model_class("recruitment", "candidate")
...
if apps.is_installed("asset"):
    ...
    def dashboard_asset_table(request):
        ...
        """
        AssetAssignment = get_friday_model_class(
...
if apps.is_installed("pms"):
    ...
    def dashboard_feedback_table(request):
        ...
        Feedback = get_friday_model_class(app_label="pms", model="feedback")
