...
class OffboardingStage(FridayModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(FridayModel):
    """
...
class OffboardingEmployee(FridayModel):
    """
...
class ResignationLetter(FridayModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_friday_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(FridayModel):
    """
...
class EmployeeTask(FridayModel):
    """
    EmployeeTask model
    """
...
class OffboardingNote(FridayModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(FridayModel):
    """
