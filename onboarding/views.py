...
from base.models import FridayMailTemplate, JobPosition
...
from friday.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = FridayMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        FridayMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
