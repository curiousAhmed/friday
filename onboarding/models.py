...
class OnboardingStage(FridayModel):
    """
    ...
    objects = FridayCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(FridayModel):
    """
    ...
    objects = FridayCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(FridayModel):
    """
...
class CandidateTask(FridayModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(FridayModel):
    """
