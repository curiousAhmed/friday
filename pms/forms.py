...
from base.forms import ModelForm as FridayModelForm
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = FridayMultiSelectField(
        ...
        self.fields["managers"] = FridayMultiSelectField(
            queryset=Employee.objects.all(),
            widget=FridayMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(FridayModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Friday multi-select filter for subordinates
        # self.fields["subordinate_id"] = FridayMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=FridayMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class BonusPointSettingForm(FridayModelForm):
    """
...
class EmployeeBonusPointForm(FridayModelForm):
    """
...
class EmployeeFeedbackForm(FridayModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = FridayMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=FridayMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], FridayMultiSelectField):
...
class BulkFeedbackForm(FridayModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = FridayMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=FridayMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], FridayMultiSelectField):
