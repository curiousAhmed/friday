...
from friday.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.FridaySectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.FridayNavView):
    """
...
class BonusPointSettingFormView(views.FridayFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.FridayListView):
    """
...
class EmployeeBonusPointSectionView(views.FridaySectionView):
    """
...
class EmployeeBonusPointNavView(views.FridayNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.FridayFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.FridayListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.FridayFormView):
    """
...
class BulkFeedbackFormView(views.FridayFormView):
    """
    Feedback other employee form View
    """
