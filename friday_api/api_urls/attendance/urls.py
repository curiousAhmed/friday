"""
friday_api/urls/attendance/urls.py
"""

from django.urls import path

from friday_api.api_views.attendance.permission_views import AttendancePermissionCheck
from friday_api.api_views.attendance.views import *
